...
For an existing TeamSpend database, run [`supabase/migrations/20260804_professional_settings.sql`](supabase/migrations/20260804_professional_settings.sql) once to enable Vietnamese đồng. Euro is also available in the currency menu.
